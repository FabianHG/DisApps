...
class GameActivity : AppCompatActivity(),View.OnClickListener {
    ...
    private fun update(){
        when{
            ...
            cells.size==totalCell->{
                ...
                txtResult.text=resources.getString(R.string.nextPlayer,if(isX)x else o)
            }
        }
    }
    ...
    fun newGame(){
        ...
        isX=true
        winner=""
        txtResult.text=resources.getString(R.string.nextPlayer,x)
